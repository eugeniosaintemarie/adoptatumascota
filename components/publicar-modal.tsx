    ...
    return (
      <Dialog open={isOpen} onOpenChange={handleClose}>
        <DialogContent className="bg-background sm:max-w-md">
          <DialogHeader>
            <DialogTitle>
              Inicia sesión para publicar una mascota en adopción
            </DialogTitle>
          </DialogHeader>
          <Button
            className="w-full"
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="Describí a la mascota, su personalidad, necesidades..."
              rows={3}
              required
            />
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-2">
              <Label htmlFor="ubicacion">Tu ubicación (donde está la mascota)</Label>
              <Input
                id="ubicacion"
                type="text"
                value={ubicacion}
