...
export function PerfilModal({
  ...
  const [closeReason, setCloseReason] = useState<"adoptada" | "transitada" | "">("")
  ...
  const handleClosePublicacion = async () => {
    ...
    const motivo = closeReason === "transitada" ? "en_transito" : "adoptado"
          ...
          <TabsContent value="publicaciones" className="space-y-4 mt-4">
            ...
            {userPublicaciones.length > 0 ? (
              <div className="space-y-4">
                ...
                {selectedPublicacion && (
                  <Select value={closeReason} onValueChange={(v) => setCloseReason(v as "adoptada" | "transitada")}>
                    <SelectTrigger className="w-full">
                      <SelectValue placeholder="Seleccionar motivo de cierre..." />
                    </SelectTrigger>
                    <SelectContent>
                      <SelectItem value="adoptada">
                ...
                <Button
                  ...
                  className="w-full"
                >
                  {isLoading ? "Cerrando..." : closeReason === "transitada" ? "Dar tránsito" : "Confirmar adopción"}
                </Button>
              </div>
            ) : (
