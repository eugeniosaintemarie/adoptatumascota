...
export function PublicacionCard({
  ...
  const handleShare = async () => {
    ...
    const title = `${especieLabels[mascota.especie]} ${generoLabels[mascota.sexo].toLowerCase()} ${razasLabels[mascota.raza]} en adopción en ${publicacion.ubicacion}`
    ...
    >
      <div className="relative aspect-square overflow-hidden bg-muted">
        <Image
          ...
          alt={`${especieLabels[mascota.especie]} en adopción`}
          fill
                ...
                <>
                  ...
                  <div className="space-y-0.5 rounded-lg bg-primary/10 p-3 overflow-hidden">
                    <div className="flex items-center gap-1.5 mb-1">
                      ...
                      <span className="text-xs font-medium text-primary">Contacto de adopción</span>
                    </div>
                  ...
                  <div className="space-y-0.5 rounded-lg bg-secondary/50 p-3 overflow-hidden">
                    <div className="flex items-center gap-1.5 mb-1">
                      ...
                      <span className="text-xs font-medium text-muted-foreground">Publicado por</span>
                    </div>
                    <p className="text-sm font-medium text-foreground">
